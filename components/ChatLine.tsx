...
export function ChatLine({ who = 'assistant', message }: Message) {
  ...
  return (
    ...
    >
      <BalancerWrapper>
        <div className="float-right mb-5 rounded-lg bg-white px-4 py-5 shadow-lg ring-1 ring-zinc-100 sm:px-6 opacity-75">
          <div className="flex space-x-3">
            <div className="flex-1 gap-4">
              ...
              <p
                className={clsx(
                  'text ',
                  who == 'assistant' ? 'font-semibold font- ' : 'text-gray-400'
                )}
              >
                {formatteMessage}
              </p>
